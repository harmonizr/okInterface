...
.replace(/"annual_fee_begin_time":".*?\"/g,'"annual_fee_begin_time":"2025-12-28 15:51:09"')
.replace(/"annual_fee_end_time":".*?\"/g,'"annual_fee_end_time":"2026-12-08 15:51:09"')
...
.replace(/"roam_end_time":".*?\"/g,'"roam_end_time":"2026-02-21 21:54:36"')
...
.replace(/"roam_begin_time":".*?\"/g,'"roam_begin_time":"2025-12-21 21:54:36"')
.replace(/"y_type":\d/g,'"y_type":1')
.replace(/"signed_svip_before":\d/g,'"signed_svip_before":8')
.replace(/"end_time":".*?\"/g,'"end_time":"2026-02-21 21:54:36"')
.replace(/"duration":\d+/g,'"duration":259200000')
.replace(/"p_grade":\d+/g,'"p_grade":20')
.replace(/"p_current_point":\d+/g,'"p_current_point":259200000')
...
.replace(/"m_end_time":"\d+"/g,'"m_end_time":"2026-12-08 15:51:09"')
