...
var rule = {
    ...
    lazy: $js.toString(() => {
        try {
            ...
            // 3. 解析 JSON，提取 url 字段（Base64 字符串）
            ...
            // 4. 第一次 Base64 解码（得到包含前缀和密文的完整字符串）
            let decodedStr;
